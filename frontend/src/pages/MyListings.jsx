...
import { platformIcons, dummyListings } from '../assets/assets';
...
const MyListings = () => {
    ...
    const [balance] = useState(DUMMY_BALANCE);
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'ban': return 'text-red-800';
            case 'sold': return 'text-indigo-800';
    ...
    return (
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
                <StatCard title='Total Listings' value={listings.length} icon={<Eye className='size-6 text-indigo-600' />} color='indigo' />
            ...
            <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
                <p className='text-sm text-gray-500'>
                    ...
                    <span className='text-indigo-600'>Profile Marketplace</span>{' '}
                    All rights reserved.
                </p>
            </div>
        </div>
